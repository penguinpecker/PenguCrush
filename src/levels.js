...
const LEVELS = [
...

  {
    ...
    scoreScale: 1,
    tiles: ['ice', 'fish', 'popsicle', 'frostice'],
    objective: { type: 'score', target: 9300 },
    blockers: [],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [9300, 13900, 17400],
    bg: '/assets/board/bg-arctic.png',
    gridTint: 0x88DDFF,
  },

  {
    ...
    scoreScale: 1,
    tiles: ['ice', 'fish', 'popsicle', 'frostice'],
    objective: { type: 'score', target: 8200 },
    blockers: [],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [8200, 12900, 16100],
    bg: '/assets/board/bg-arctic.png',
    gridTint: 0x88DDFF,
  },
...

  {
    ...
    scoreScale: 4.5,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp'],
    objective: { type: 'combo', scoreTarget: 21400, blockerType: 'frozen', blockerCount: 8 },
    blockers: [{ type: 'frozen', count: 8 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [21400, 25700, 32100],
    bg: '/assets/board/bg-penguin-city.png',
    gridTint: 0xFFB74D,
  },
...

  {
    ...
    scoreScale: 11.7,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp', 'crab'],
    objective: { type: 'combo', scoreTarget: 22700, blockerType: 'ice', blockerCount: 6 },
    blockers: [{ type: 'ice', count: 6, layers: 2 }, { type: 'wall', count: 3 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [22700, 27200, 34000],
    bg: '/assets/board/bg-volcano-ice.png',
    gridTint: 0xFF6B3D,
  },
...

  {
    ...
    scoreScale: 12.2,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp', 'crab'],
    objective: { type: 'combo', scoreTarget: 25200, surviveDrops: 8 },
    blockers: [{ type: 'frozen', count: 3 }, { type: 'wall', count: 2 }, { type: 'faller', interval: 3 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [25200, 30200, 37800],
...

  {
    ...
    scoreScale: 13.6,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp', 'crab'],
    objective: { type: 'combo', scoreTarget: 27000, blockerType: 'ice', blockerCount: 6 },
    blockers: [{ type: 'ice', count: 6, layers: 2 }, { type: 'wall', count: 3 }, { type: 'faller', interval: 3 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [27000, 32400, 40500],
    bg: '/assets/board/bg-skylands.png',
    gridTint: 0xBB88FF,
  },
