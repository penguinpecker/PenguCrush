...
const LEVELS = [
...

  {
    ...
    scoreScale: 1,
    tiles: ['ice', 'fish', 'popsicle', 'frostice'],
    objective: { type: 'score', target: 13100 },
    blockers: [],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [13100, 18100, 21500],
    bg: '/assets/board/bg-arctic.png',
    gridTint: 0x88DDFF,
  },

  {
    ...
    scoreScale: 1,
    tiles: ['ice', 'fish', 'popsicle', 'frostice'],
    objective: { type: 'score', target: 12200 },
    blockers: [],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [12200, 17500, 20600],
    bg: '/assets/board/bg-arctic.png',
    gridTint: 0x88DDFF,
  },

  {
    ...
    scoreScale: 1.1,
    tiles: ['ice', 'fish', 'popsicle', 'frostice'],
    objective: { type: 'score', target: 13500 },
    blockers: [],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [13500, 18700, 22400],
    bg: '/assets/board/bg-arctic.png',
    gridTint: 0x88DDFF,
  },
...

  {
    ...
    scoreScale: 4.5,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp'],
    objective: { type: 'combo', scoreTarget: 22700, blockerType: 'frozen', blockerCount: 8 },
    blockers: [{ type: 'frozen', count: 8 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [22700, 27800, 35000],
    bg: '/assets/board/bg-penguin-city.png',
    gridTint: 0xFFB74D,
  },
...

  {
    ...
    scoreScale: 11.7,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp', 'crab'],
    objective: { type: 'combo', scoreTarget: 26600, blockerType: 'ice', blockerCount: 6 },
    blockers: [{ type: 'ice', count: 6, layers: 2 }, { type: 'wall', count: 3 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [26600, 31500, 38800],
    bg: '/assets/board/bg-volcano-ice.png',
    gridTint: 0xFF6B3D,
  },
...

  {
    ...
    scoreScale: 12.2,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp', 'crab'],
    objective: { type: 'combo', scoreTarget: 30800, surviveDrops: 8 },
    blockers: [{ type: 'frozen', count: 3 }, { type: 'wall', count: 2 }, { type: 'faller', interval: 3 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [30800, 35100, 43600],
...

  {
    ...
    scoreScale: 13.6,
    tiles: ['ice', 'fish', 'popsicle', 'frostice', 'shrimp', 'crab'],
    objective: { type: 'combo', scoreTarget: 31900, blockerType: 'ice', blockerCount: 6 },
    blockers: [{ type: 'ice', count: 6, layers: 2 }, { type: 'wall', count: 3 }, { type: 'faller', interval: 3 }],
    boosters: ['row', 'col', 'colorBomb', 'hammer', 'shuffle'],
    stars: [31900, 36100, 43800],
    bg: '/assets/board/bg-skylands.png',
    gridTint: 0xBB88FF,
  },
